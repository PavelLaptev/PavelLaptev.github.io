const OtherProjects = [
  {
    ...
    text:
      "How to create motion and visual illusions with simple 3d shapes and tile text textures.",
    date: "15.1.2021",
    new: false,
  },
  {
  ...
  },
  {
    ...
    text:
      "Experience in making complex but simple CSS frameworks based on Flexbox and SCSS.",
    date: "0.0.0",
    new: false,
  },
  {
    ...
    text:
      "As a fan of Brutalist architecture, I made an interactive map using D3.js. You can manage buildings on the map by date of construction with a range slider.",
    date: "0.0.0",
    new: false,
  },
  {
  ...
  },
  {
    ...
    text:
      "Often, while working on a design system, we have to keep detailed documentation. For this purpose, the “Markdown Theme Shell” was made, it parses the markdown file in the HTML page, creating a sidebar and content area.",
    date: "0.0.0",
    new: false,
  },
  {
    ...
    text:
      "To demonstrate the power of Figma API I made this webpage as an experiment. On this page you could get a full JSON structure, pages and nested artboards, and also filter all by a flag name.",
    date: "0.0.0",
    new: false,
  },
];
